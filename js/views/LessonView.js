...
export function renderLockedScreen(chapterNumber, previousTitle) {
...
export function renderHeader(chapterNumber, chapter, total) {
...
export function renderCourseProgress({ completed, total, percent }) {
...
export function renderVideo(chapterNumber, chapter) {
 ...
 */
export function renderExercise(exercise, onSubmit) {
...
export function showFeedback(message, tone) {
  if (!feedbackNode) {
    return;
  }
...
export function showIncorrect(message, guidance) {
...
export function showSolved(exercise) {
  const mount = document.querySelector("[data-exercise]");
...
export function renderCompletion({ materialViewed, exercisePassed, alreadyDone, chapterNumber }) {
...
export function renderNextStep(chapterNumber, total, nextChapterData) {
...
export function showCourseComplete() {
...
export function renderChapterNav(chapterNumber, total, isNextUnlocked) {
