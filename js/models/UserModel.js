...
Pung.UserModel = (function () {
  "use strict";

  const { readJSON, writeJSON, remove } = Pung.StorageService;
  const { isValidEmail, normaliseEmail, isLongEnough, isNotBlank } = Pung.ValidationService;
  ...
  return { findUser, getCurrentUser, getUsers, login, logout, register, startSession, validateRegistration };
})();
